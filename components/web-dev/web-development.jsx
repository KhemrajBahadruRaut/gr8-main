  ...
  const processSteps = useMemo(
    () => [
      ...
      },
      {
        ...
        description:
          "Our design team creates intuitive user interfaces and interactive prototypes that align with your brand identity and user needs.",
      },
      {
        number: "03",
        title: "Development & Testing",
        description:
          "We build robust, scalable applications using modern technologies while maintaining rigorous quality assurance and testing standards.",
      },
      {
        number: "04",
        title: "Launch & Support",
        description:
          "We deploy your solution and provide ongoing maintenance, updates, and technical support to ensure optimal performance.",
      },
    ],
    [],
  );
    ...
    () => [
      {
        ...
        answer:
          "Project timelines vary based on complexity, but most websites take 4-8 weeks from concept to launch. We provide detailed timelines during our initial consultation.",
      },
      {
        question:
          "Do you provide ongoing maintenance and support after launch?",
        answer:
          "Yes, we offer comprehensive maintenance packages including security updates, performance monitoring, and technical support to keep your website running smoothly.",
      },
      {
        question:
          "Can you work with our existing design or branding guidelines?",
        answer:
          "Absolutely! We can work with your existing brand assets and design guidelines, or help you create new ones that better represent your business.",
      },
      {
        question: "What technologies do you recommend for e-commerce websites?",
        answer:
          "For e-commerce, we recommend robust platforms like Shopify, WooCommerce, or custom solutions using React/Next.js with secure payment integrations.",
      },
    ],
    [],
  );
  ...
  return (
    <div className="pt-10 bg-[#0a1520] text-white">
      ...
      <motion.section
        ...
        variants={containerVariants}
      >
        <SectionHeader subtitle="EXPLORE FOR THE WEEK" title="Overview" />
        ...
        <motion.div className="space-y-6 mb-12" variants={containerVariants}>
          <motion.p
            ...
            variants={itemVariants}
          >
            We specialize in creating custom web solutions that combine
            cutting-edge technology with user-centered design for measurable
            business results.
          </motion.p>
        </motion.div>
      ...
      <motion.section
        ...
        variants={containerVariants}
      >
        <SectionHeader subtitle="PLANNING & FRAMEWORK" title="Our Process" />
      ...
      <motion.section
        ...
        variants={containerVariants}
      >
        <SectionHeader subtitle="OUR TECH STACK" title="Technologies We Use" />
