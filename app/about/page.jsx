...
const TeamMember = React.memo(({ member, index, level = 0 }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute inset-0 bg-linear-to-r ${getGlowColor()} opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl blur-xl`}
      ></div>
      ...
      <div className="relative mb-6 z-10 ">
        ...
        <div
          className={`absolute -bottom-2 -right-2 w-10 h-10 ${getBadgeColor()} rounded-full flex items-center justify-center border-2 border-slate-900`}
        >
      ...
      <p className="text-slate-300 text-sm mb-6 leading-relaxed z-10 ">
        {member.bio}
      </p>
  ...
  const values = [
    {
      ...
      description:
        "We actively listen to, understand, and prioritize the unique needs of our clients, tenants, and users, ensuring exceptional service and customized solutions.",
    },
    {
      icon: Scale,
      title: "Integrity",
      description:
        "We conduct business with honesty, ethics, and transparency, earning trust through consistent and responsible actions.",
    },
    {
      icon: Anchor,
      title: "Reliability",
      description:
        "We provide reliable services both digital and physical that clients and tenants can trust.",
    },
    {
      icon: Rocket,
      title: "Innovation",
      description:
        "We consistently embrace new technologies and innovative strategies to enhance property operations and digital experiences.",
    },
    {
      icon: Leaf,
      title: "Sustainability",
      description:
        "We are committed to environmentally responsible practices and sustainable solutions for long-term success.",
    },
    {
      icon: Target,
      title: "Excellence",
      description:
        "We strive for the highest standards in all our services, continuously improving and delivering quality results.",
    },
    {
      icon: Zap,
      title: "Efficiency",
      description:
        "We optimize processes and leverage technology to deliver fast, effective solutions without compromising quality.",
    },
    {
      icon: HeartHandshake,
      title: "Partnership",
      description:
        "We build long-term relationships based on mutual trust, collaboration, and shared success with our clients.",
    },
    {
      icon: Building,
      title: "Growth",
      description:
        "We foster continuous growth and development for our company, clients, and community through innovative solutions.",
    },
  ];
  ...
  const teamHierarchy = [
    ...
    // Level 2: Team Members
    {
      ...
      members: [
        ...
        {
          name: "Anup Shrestha",
          role: "Creative Design Architect",
    ...
    <section className="bg-[#101820] py-20 px-6 relative overflow-hidden lg:pt-32">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <h1
            className="text-5xl md:text-6xl font-bold text-white animate-fade-in-up"
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-20">
          ...
          >
            <h2
              className="text-3xl font-bold text-white mb-6 animate-fade-in-up"
            ...
            <div className="space-y-4">
              <p
                className="text-slate-300 leading-relaxed animate-fade-in-up"
                style={{ animationDelay: "500ms" }}
              >
                GR8 Private Limited is a premier digital agency specializing in
                comprehensive digital solutions including website development,
                digital marketing, SEO, software development, and creative
                design services.
              </p>
              <p
                className="text-slate-300 leading-relaxed animate-fade-in-up"
              ...
              >
                Founded with a vision to empower businesses in the digital age,
                we combine cutting-edge technology with creative excellence to
                deliver measurable results and exceptional digital experiences
                for our clients.
              </p>
            </div>
          </div>
          ...
          >
            <div
              className="bg-slate-800/30 rounded-lg p-6 border border-slate-700/30 hover:border-orange-500/30 transition-all duration-500 hover:transform hover:scale-105 animate-fade-in-up"
              style={{ animationDelay: "700ms" }}
            >
              <p className="text-slate-300 leading-relaxed">
                We bridge the gap between business goals and digital success
                through our comprehensive suite of services: from responsive
                website development and e-commerce solutions to strategic
                digital marketing campaigns, SEO optimization, social media
                management, and custom software applications. Our holistic
                approach ensures your business thrives in the competitive
                digital landscape.
              </p>
            </div>
            <div
            ...
            >
              <p className="text-slate-300 leading-relaxed">
                Our expertise extends to UI/UX design, content marketing, PPC
                advertising, analytics, and mobile app development. We stay
                ahead of digital trends to incorporate emerging technologies
                like AI-driven marketing automation, progressive web apps, and
                data-driven SEO strategies. Partner with us for a complete
                digital transformation that drives growth, enhances visibility,
        ...
        <div className="mb-20 ">
          ...
          >
            ...
            <h2
              className="text-4xl md:text-5xl font-bold text-white animate-fade-in-up"
              style={{ animationDelay: "900ms" }}
            >
              Meet Our Leadership & Team
            </h2>
            <p
              className="text-slate-300 max-w-2xl mx-auto mt-4 animate-fade-in-up"
              style={{ animationDelay: "1000ms" }}
            >
              A hierarchical structure of experts driving innovation and
        ...
        <div className="mb-12">
          <div
            className={`text-center mb-12 transition-all duration-1000 delay-1100 ${
              isVisible
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-10"
            }`}
