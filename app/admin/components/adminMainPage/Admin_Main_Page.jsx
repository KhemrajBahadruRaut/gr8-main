          ...
          <AnimatePresence>
            {sidebarOpen && (
              ...
              >
                ...
                <button onClick={handleLogout} className="w-full flex items-center gap-3 px-3 py-2 text-gray-400 hover:text-white hover:bg-gray-800/50 rounded-lg transition-colors">
      ...
      <main className="flex-1 overflow-hidden flex flex-col transition-all duration-300">
        ...
        <footer className="bg-white border-t border-gray-200 px-6 py-3">
          <div className="flex items-center justify-between text-sm text-gray-600">
            ...
            <div className="flex items-center gap-4">
              <span>© 2024 GR8 Nepal Pvt. Ltd.</span>
            </div>
          </div>
        </footer>
      </main>
